...
- **2026-07-08 — Fix GL : charges télécom postées en 5900 au lieu de 5050/5051 (feature #7.9)**
  ...
  - **Remédiation prod** : après déploiement, re-poster les dépenses télécom déjà en 5900 (edit-save OU `POST /api/ledger/autopost/backfill`) → elles migrent vers 5051/5050.
  - Tests : `test_gl_expense_account_autocreate.py` (8 tests : création 5050/5051, idempotence, fallback 5900 pour non-mappé, compte pris par autre catégorie, anti-doublon mapping, rattachement orphelin). 289 tests GL/dépenses voisins verts.
