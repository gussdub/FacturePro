...
- **2026-08-20 — Correctifs de sécurité P0 (audit Loi 25) — auth, fichiers, brute-force, webhook**
  ...
  - **Limites/suivi** : délivrabilité du reset dépend désormais entièrement de Resend (si mal configuré → aucun reset possible, message générique quand même — surveiller) ; MFA/SSO/journal d'audit/portabilité/effacement/ÉFVP transfert hors Québec = backlog P1/P2 du rapport d'audit (gabarits DOC à rédiger).
