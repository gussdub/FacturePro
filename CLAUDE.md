...
- **2026-07-04 — Grand livre Phase 2 — auto-posting (feature #12.2)**
  ...
  - Tests : **51 unitaires + 96 intégration (backend) + 32 frontend = 179 nouveaux tests**, tous verts (isolation cross-org, idempotence, net-zéro sur edit/delete, réconciliation), 0 régression Phase 1.
