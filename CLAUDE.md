...
- **2026-09-14 — Backlog P1 de l'audit Loi 25 : 10 livraisons (rattrapage de documentation)**
  ...
  - Reste du backlog Loi 25 : **journal d'audit**, **ÉFVP** pour les transferts de RP hors Québec (art. 17), **responsable des RP** (art. 3.1), consentement PIPEDA non enregistré à `/api/auth/register`, les 9 refactors `react-hooks/exhaustive-deps`.
...
- **2026-08-20 — Correctifs de sécurité P0 (audit Loi 25) — auth, fichiers, brute-force, webhook**
  ...
  - **Limites/suivi** : délivrabilité du reset dépend désormais entièrement de Resend (si mal configuré → aucun reset possible, message générique quand même — surveiller) ; ~~MFA/SSO/journal d'audit/portabilité/effacement~~ → **MFA, SSO, portabilité (art. 27) et effacement (art. 28.1) sont LIVRÉS** (cf. entrées du 2026-08-21 et du 2026-09-14). Restent au backlog : **journal d'audit**, **ÉFVP** pour les transferts de RP hors Québec, **responsable des RP** (art. 3.1) — gabarits DOC à rédiger.
