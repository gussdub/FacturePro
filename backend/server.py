    ...
    <body>
        <div class="header">
            ...
            <div class="doc-info">
                ...
                {f'<div style="color: #6b7280;">Valide jusqu{apostrophe}au: {valid_until}</div>' if valid_until else ''}
            </div>
        </div>
...
async def send_quote_email(
    ...
    try:
        ...
        # Generate PDF attachment
        pdf_bytes = generate_invoice_pdf(quote, company_name, logo_url, primary_color)
        ...
        resend.Emails.send({
            ...
            "html": html_content,
            "attachments": [{
                "filename": f"Soumission_{quote['quote_number']}.pdf",
                "content": base64.b64encode(pdf_bytes).decode()
            }]
        })
